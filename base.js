...
var Base = (function () {
    ...
    Base.prototype.getCacheDir = function (filename) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, uni_utils_1.default.checkFile(this.config.cacheDir)];
                    case 1:
                        checkDirExist = _a.sent();
                        if (!checkDirExist) {
                            this.config.debug && console.log('自定义缓存目录不存在，使用临时目录');
                            return [2, cacheFile];
                        }
                        cacheFile = path_1.default.join(this.config.cacheDir, filename);
                        return [2, cacheFile];
                }
            });
        });
    };
    Base.prototype.request = function (url, data, method) {
        return __awaiter(this, void 0, void 0, function () {
            var timeStamp, csRes;
            return __generator(this, function (_a) {
                switch (_a.label) {
